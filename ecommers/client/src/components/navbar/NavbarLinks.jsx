    ...
    <div>
        <ul className='hidden sm:flex gap-11 text-sm text-gray-700'>
                        ...
                        <NavLink to='/art'  onClick={()=>setValue('aer')} >
                         ...
                         {/* <NavLink to='/drawings'  onClick={()=>setValue('drawings')} >
                            <p className={`${value === 'drawings' ? 'bg-black text-white rounded-2xl' : 'text-black'} p-1  flex flex-col items-center gap-1 font-extrabold`} >REPAIR</p>
                        </NavLink> */}
